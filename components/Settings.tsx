...
const getDeleteReasons = (t: any) => [
  t('reasonNotUsing') || "I don't use the app anymore",
  t('reasonMissingFeatures') || "I'm missing features",
  t('reasonTooComplicated') || "The app is too complicated",
  t('reasonOtherApp') || "I found another app",
  t('reasonTechnicalIssues') || "Technical problems",
  t('reasonOther') || "Other..."
];
        ...
        if (user && user.email) {
           ...
           if (error) {
              if (error.message.includes('does not exist')) {
                 alert("System error: Table 'deletion_requests' does not exist. Please contact support.");
              } else {
                 throw error;
              }
           } else {
               ...
               <div className="space-y-6 animate-fade-in">
                  ...
                  <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
                     <div className="flex items-center gap-3 mb-4">
                        ...
                        <h4 className="font-bold text-lg text-slate-800 dark:text-white">Session</h4>
                     </div>
                  ...
                  <div className={`bg-amber-50 dark:bg-amber-900/10 p-4 rounded-xl border border-amber-200 dark:border-amber-900/30 relative overflow-hidden transition-all ${!isAdmin ? 'blur-[2px] pointer-events-none select-none' : ''}`}>
                     ...
                     <div className="mt-4 pt-4 border-t border-amber-200 dark:border-amber-800">
                        ...
                        <p className="text-[10px] text-slate-500 mt-1">
                           e.g. $1.46 &rarr; $1.49 | $2.71 &rarr; $2.79
                        </p>
                     </div>
                  </div>
            ...
            <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-700">
               ...
               <div className="p-6 space-y-6">
                  <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-xl border border-amber-200 dark:border-amber-900/50 text-sm text-amber-800 dark:text-amber-200 leading-relaxed">
                     <strong>Notice:</strong> After confirmation, all your data (inventory, settings, history) will be permanently deleted within <strong>48 hours</strong>. This cannot be undone.
                  </div>
