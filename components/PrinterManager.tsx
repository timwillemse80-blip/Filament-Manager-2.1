                  ...
                  {printer.hasAMS ? (
                     ...
                     <div>
                        <div className="flex items-center gap-2 mb-2">
                           ...
                           <span className="text-xs font-bold text-slate-500 uppercase tracking-widest">{t('activeFilament')}</span>
                        </div>
               ...
               <div className="p-6 overflow-y-auto space-y-6">
                  <form id="printerForm" onSubmit={handleSubmit} className="space-y-6">
                     ...
                     <div className="grid grid-cols-2 gap-4">
                        <div>
                           <label className="text-xs font-bold text-slate-500 uppercase mb-1 block tracking-widest">{t('brand')}</label>
                           {isCustomBrand ? (
                        ...
                        <div>
                           <label className="text-xs font-bold text-slate-500 uppercase mb-1 block tracking-widest">{t('printerModel')}</label>
                     ...
                     <div className={`bg-amber-50 dark:bg-amber-900/10 p-4 rounded-xl border border-amber-200 dark:border-amber-900/30 relative overflow-hidden ${!isAdmin ? 'opacity-70 grayscale' : ''}`}>
                        ...
                        <h4 className="text-xs font-bold text-amber-600 dark:text-amber-400 uppercase mb-3 flex items-center gap-1 tracking-widest">
                           <Coins size={14} /> {t('printerSpecs')}
                        </h4>
                        
                        <div className="grid grid-cols-3 gap-3">
                           <div>
                              <label className="text-[10px] font-bold text-slate-500 uppercase mb-1 block tracking-wider" title={t('printerPower')}>{t('printerPower')}</label>
                           ...
                           <div>
                              <label className="text-[10px] font-bold text-slate-500 uppercase mb-1 block tracking-wider" title={t('printerCost')}>{t('printerCost')}</label>
                              <div className="relative">
                                 <input 
                                    type="number" 
                                    disabled={!isAdmin}
                           ...
                           <div>
                              <label className="text-[10px] font-bold text-slate-500 uppercase mb-1 block tracking-wider" title={t('printerLifespan')}>{t('printerLifespan')}</label>
                              <div className="relative">
                                 <input 
                                    type="number" 
                                    disabled={!isAdmin}
