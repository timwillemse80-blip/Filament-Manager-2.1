...
drop policy if exists "Users create requests" on public.deletion_requests;
create policy "Users create requests" on public.deletion_requests for insert with check (auth.uid() = user_id);
drop policy if exists "Users see own requests" on public.deletion_requests;
create policy "Users see own requests" on public.deletion_requests for select using (auth.uid() = user_id);
drop policy if exists "Users delete own requests" on public.deletion_requests;
...
drop policy if exists "Spools read" on public.spool_weights;
