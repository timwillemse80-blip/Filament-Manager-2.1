export const COMMON_BRANDS = [
  "Prusament", "eSun", "Sunlu", "Bambu Lab", "Polymaker", 
  "Eryone", "Overture", "Hatchbox", "Creality", "Anycubic", 
  "Formfutura", "ColorFabb", "123-3D (Jupiter)", "Real Filament", 
  "Geetech", "Amazon Basics", "Elegoo", "Flashforge",
  "Innofil3D", "Fiberlogy", "Das Filament", "Extrudr", 
  "Fillamentum", "Spectrum", "Devil Design"
];
...
export const COMMON_COLORS = [
  ...
  { name: "Glow in the Dark", hex: "#CCFFCC" },
  { name: "Regenboog", hex: "#FF00FF" }
];
...
export const ENGLISH_COLOR_MAP: Record<string, { name: string, hex: string }> = {
  ...
  "rainbow": { name: "Regenboog", hex: "#FF00FF" },
  "galaxy black": { name: "Zwart", hex: "#111111" },
  "galaxy silver": { name: "Zilver", hex: "#C0C0C0" },
  "galaxy purple": { name: "Paars", hex: "#800080" },
  "navy": { name: "Blauw", hex: "#000080" },
  "olive": { name: "Groen", hex: "#808000" },
  "teal": { name: "Blauw", hex: "#008080" }
};

// Pas deze link aan naar jouw eigen Discord invite link!
